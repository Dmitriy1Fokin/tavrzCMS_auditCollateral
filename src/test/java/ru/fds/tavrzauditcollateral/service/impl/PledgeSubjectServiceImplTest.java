...
class PledgeSubjectServiceImplTest {
    ...
    void getAuditResultsAboutObject() {
        Collection<AuditResult> auditResults = pledgeSubjectService.getAuditResultsAboutObject(TestUtils.getTestAuditResult().getObjectId());
        assertEquals(2, auditResults.size());
    }

    @Test
    void testGetAuditResultsAboutObject() {
        Collection<AuditResult> auditResults = pledgeSubjectService.getAuditResultsAboutObject(TestUtils.getTestAuditResult().getObjectId(), AuditStatus.ACTUAL);
        assertEquals(2, auditResults.size());
    }
}